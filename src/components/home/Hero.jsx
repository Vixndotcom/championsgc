...
const Hero = () => {
   return (
     <section className={`${styles.flexStart} `} >
       ...
       <h1 className=' mt-20 text-shadow text-start text-white mb-20' >
...
{/* central div */}
<div className='md:flex md:flex-row md:gap-40 z-[999] mb-20 '>
      ...
      <button className=' w-[320px]  arrow  rounded-[12px] bg-arrow mt-12  ' >
